...
#   
# ADVANCED SHAP MODEL
# VARS CONSIDERED: (goldearned, goldspent, champlvl, KDA, killingsprees, kills, 
# turretkills, inhib kills, CS, visionscore, pinkwards, damage taken/dealt)
# per min
#
...
rate_features_rm = [
    ...
    "totheal", "totunitshealed", "dmgtoobj", "timecc",
    "neutralminionskilled", "ownjunglekills",
    "enemyjunglekills", "totcctimedealt", "wardsbought",
    "wardsplaced", "wardskilled",
    "firstblood","dmgtoturrets", "dmgselfmit", "largestcrit", 
...
full_names = {
    ...
    "kills": "Kills per min",
    "turretkills" : "Turret kills per min",
    "visionscore" : "Vision score per min",
    "totminionskilled" : "Minion kills per min",
    "win": "Win or Loss"
}
...
shap.dependence_plot("Turret kills per min", shap_values, Xv, interaction_index="Gold earned per min")
